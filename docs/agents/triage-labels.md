...
Category labels currently available include `bug`, `enhancement`, `documentation`, and `duplicate`. Use exactly one category label during triage when the issue clearly fits one.
